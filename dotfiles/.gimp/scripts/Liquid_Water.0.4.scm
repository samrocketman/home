...
(define (Aply-script-fu-Liquid-Water img Bump-Layer Back-color ShapeW DropsA LightA Dont_Merge)
...
(let* ((Highlight_up   (car (gimp-layer-copy Bump-Layer FALSE)))
    ...
    (gimp-layer-set-name Background-Color_calque "Background")
...
(define (script-fu-Liquid-Water-logo-alpha img Bump-Layer Back-color  ShapeW DropsA LightA Dont_Merge)
(begin
         (Aply-script-fu-Liquid-Water img Bump-Layer Back-color ShapeW DropsA LightA Dont_Merge)
         (gimp-displays-flush)))
...
(script-fu-register "script-fu-Liquid-Water-logo-alpha"
			...
			SF-COLOR "Background" '(0 0 255)
		        ...
		        SF-TOGGLE _"Don't merge layers" FALSE
			)

(define (script-fu-Liquid-Water-logo font size text Back-color ShapeW DropsA LightA Dont_Merge)
  ...
  (let* ((img (car (gimp-image-new 256 256  RGB)))	; nouvelle image -> img
    ...
    (Aply-script-fu-Liquid-Water img text-layer Back-color ShapeW DropsA LightA Dont_Merge)
