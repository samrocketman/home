...
(define (script-fu-wb-puzzle aimg adraw puzzlewidth puzzleheight feathervalue)
...
(script-fu-register "script-fu-wb-puzzle"
...
(script-fu-menu-register "script-fu-wb-puzzle" _"<Image>/Filters/Light and Shadow")
